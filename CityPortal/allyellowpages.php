...
<div id="centerContainer">
                        <div id="leftContainer">
                             <?php 
                                include_once $_SERVER["DOCUMENT_ROOT"]."/CityPortal1/Partials/YellowPages/YellowPageCategories.php";
                            ?>
                        ...
                        <div id="rightContainer">
                          ...
                          <img src="Uploads/kennel2.jpg" />
                           ...
                           <?php 
                                include_once $_SERVER["DOCUMENT_ROOT"]."/CityPortal1/Partials/YellowPages/YellowPagesSummaryByCategory.php";
                            ?>
