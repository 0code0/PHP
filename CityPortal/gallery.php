...
<?php
include_once $_SERVER["DOCUMENT_ROOT"] . "/CityPortal1/Partials/Gallery/PictureCategories.php";
?>
...
<?php
include_once $_SERVER["DOCUMENT_ROOT"] . "/CityPortal1/Partials/Gallery/GallerySummaryByCategory.php";
?>
