...
<?php
include_once $_SERVER["DOCUMENT_ROOT"] . "/CityPortal1/Partials/FamousPeople/PersonCategories.php";
?>
...
?>
    ...
    <div id="rightContainer">
        ...
        <h1>
            Eminent personalities in Shimla</h1>
        <div class="spacer10"></div>

        <div>

<?php
include_once $_SERVER["DOCUMENT_ROOT"] . "/CityPortal1/Partials/FamousPeople/PersonSummaryByCategory.php";
?>
