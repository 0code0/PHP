...
<body>
	<div id="container">
        ...
        <div id="wrapper">
            <div id="content">
                <h1>Manage Classifieds</h1><br>
                
                    <?php include "$siteAdminBaseFullPath/Partial/Classifieds/GetAll.php"; ?>
                    
        <br></br>
                    <a href="?show=Add">Add Classified </a> 
                    <br></br>
                    
                    <?php if($show=="Add")
                    {
                        include "$siteAdminBaseFullPath/Partial/Classifieds/Add.php" ;
                   }
                   
                   if($show=="update")
                    {
                        include "$siteAdminBaseFullPath/Partial/Classifieds/Update.php" ;
                   }
                   
                   if($show=="delete")
                    {
                        include "$siteAdminBaseFullPath/Partial/Classifieds/Delete.php" ;                    
                    }
                     if($show=="view")
                    {
                        include "$siteAdminBaseFullPath/Partial/Classifieds/GetSingle.php" ;                    
                    }
