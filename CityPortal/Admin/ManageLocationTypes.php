...
if($operation == "Add")
{
    $obj = new LocationType();
    $obj->set_Name($_GET["Name"]);
    
    LocationTypeBL::Add($obj);
}
...
<body>
  ...
  <h1>Manage Location Types</h1>
                <br>
                <?php include "$siteAdminBaseFullPath/Partial/LocationTypes/GetAll.php"; ?>
                    <br></br>
                    ...
                    <?php if($show=="Add")
                    {
                        include "$siteAdminBaseFullPath/Partial/LocationTypes/Add.php" ;
                   }
                   
                   if($show=="update")
                    {
                        include "$siteAdminBaseFullPath/Partial/LocationTypes/Update.php" ;
                   }
                   
                   if($show=="delete")
                    {
                        include "$siteAdminBaseFullPath/Partial/LocationTypes/Delete.php" ;
                   }
                     if($show=="view")
                    {
                        include "$siteAdminBaseFullPath/Partial/LocationTypes/GetSingle.php" ;
                   }
